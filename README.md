...
Diversity
> 양질의 결정을 내려야 하는 경우, 같은 생각을 가진 10명의 팀은 1명으로 대체 가능하다. 

Fairness
> 공정한 경쟁을 위해 채택하는 기준은 역설적으로 배제를 위한 도구가 될 수 있다. 따라서 진정한 공정은 기준에 따라 올바르게 평가를 하는 것을 넘어서서 기준에 대한 구성원들의 합의까지 고려해야 한다.
...
> 형태는 기능을 따른다. 형태를 먼저 만든 다음 기획을 하고 그 기획에 따라 개발하면 제품의 품질이 떨어진다.
