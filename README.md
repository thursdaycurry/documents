...
좋은 수를 놓기
> 지식이 없는 사람이 일의 방향을 설정하면, 그 일에서 얻을 수 있는 LTV(Long-Term Value)의 상한선은 낮아진다. 나쁜 수로 시작하는 것은 패널티 게임과 같다.
...
인사 전문가
> 유용한 인사 전문가는 직원들의 조직 경험이라는 상품을 설계할 수 있다. 이들의 상품은 화폐를 쓰지 않고 임금을 간접적으로 올리는 효과가 있다.
