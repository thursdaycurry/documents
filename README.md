...
Margin
> 과거 제도 문화가 강한 한국 사회에서 기업들이 인재를 채용할 때 최적의 사람을 뽑는 상한선 상향 전략보다 최악의 사람을 뽑지 않는 하한선 상향 전략을 선호하는 경향이 강하다. 표준화된 경험과 이력들을 검토한 다음 사소한 것들의 디테일을 얼마나 높였는가를 보고 평가하는 일종의 margin 경쟁과 가깝다. 이러한 방식의 효용은 산업화 시대를 지나며 감소하고 있다.
